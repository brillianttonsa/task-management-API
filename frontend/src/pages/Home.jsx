    ...
    <div>
        ...
        <div className="task-container-box">
            ...
            <div className="flex space-x-1 justify-end">
                <Button btnText={'Edit'} className="flex-center btn-with-icon p-2 bg-yellow-400 w-auto">
                ...
                <Button btnText={'Delete'} className="flex-center btn-with-icon p-2 bg-red-500 w-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
